 ...
 */
export function SessionCounter({ currentNumber, totalInSession, meta, stats }: SessionCounterProps) {
  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
      ...
      <div className="space-y-1">
        ...
        <div className="text-xs text-muted-foreground">Karta w sesji</div>
      </div>

      {/* Total due */}
      <div className="space-y-1">
        <div className="text-2xl font-bold text-foreground">{safeTotalDue}</div>
        <div className="text-xs text-muted-foreground">Do powtórki</div>
      </div>

      {/* Deck total */}
      <div className="space-y-1">
        <div className="text-2xl font-bold text-foreground">{safeDeckTotal}</div>
        <div className="text-xs text-muted-foreground">W decku</div>
      </div>
      ...
      <div className="space-y-1">
        ...
        <div className="text-xs text-muted-foreground">OK / NOK</div>
      </div>
    </div>
  );
}
