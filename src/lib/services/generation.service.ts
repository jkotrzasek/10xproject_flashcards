...
import type { GenerationInsert, GenerationErrorInsert, FlashcardProposalDto } from '../../types';
 ...
 */
export const getDailyGenerationsCount = async (
 ...
 */
export const ensureDailyLimit = async (
  supabase: SupabaseClient,
  userId: string
): Promise<void> => {
 ...
 */
export const validateFlashcardProposals = (
 ...
 */
const generateMockFlashcards = async (
  inputText: string,
  signal: AbortSignal
): Promise<FlashcardProposalDto[]> => {
